...
class GoodIDLoginInitiationEndpointTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function itBuildsRedirectionUrl()
    {
        ...
        $this->assertEquals('fast-endpoint-uri?client_id=some-client-id&state=mock-state-value&nonce=mock-nonce-value&ext=eyJzZGtfdmVyc2lvbiI6IjIuMy4zIiwicHJvZmlsZV92ZXJzaW9uIjoiMS4wIn0&pairing_nonce=&display=mobile', $url);
    }
